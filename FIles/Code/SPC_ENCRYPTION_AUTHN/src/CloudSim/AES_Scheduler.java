...
public class AES_Scheduler {
    ...
    public static void main(String[] args) {
        Log.printLine("Starting Secure File Sharing Simulator...");
        ...
        try {
            ...
            AESDatacenterBroker broker = createBroker("Broker_0");
            ...
            Log.printLine(AES_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static AESDatacenterBroker createBroker(String name) throws Exception {
        return new AESDatacenterBroker(name);
    }
